module github.com/leebrouse/eino

go 1.24.5

require (
	github.com/cloudwego/eino v0.4.4
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/semantic v0.0.0-20250814083140-54b99ff82f8e
...
require (
	...
	github.com/cloudwego/eino-ext/components/retriever/milvus v0.0.0-20250818090953-a59b1be0df04
